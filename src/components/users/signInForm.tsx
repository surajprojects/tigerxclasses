    ...
    <>
      <section className="w-full h-full p-5">
        <div className="rounded-2xl border border-gray-200 p-6 w-fit mx-auto shadow-xl">
          <FormHeader description="Sign in to manage your students and courses" />
          {/* Sign In Form */}
          <form
            onSubmit={async (evt) => {
              setIsLoading(true);
          ...
          <div className="text-sm text-gray-500 mx-auto w-fit">
            <p>
              username - <em>ram</em> | password - <em>tiger12345</em>
            </p>
          </div>
        </div>
      </section>
